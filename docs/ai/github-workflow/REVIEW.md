...
- The PR closes the exact implementation issue(s), not a parent milestone or
  epic.
...
- PR maps to a coherent group of Agent Tasks (a single task when no coherent
  grouping exists); no Agent Task is split across PRs.
