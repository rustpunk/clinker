...
- Follow the close protocol in `docs/ai/GITHUB_ISSUE_AGENT_WORKFLOW.md`: leave a final issue comment with changed behavior, files/crates touched, validation, skipped checks, and follow-up issues before closing.
