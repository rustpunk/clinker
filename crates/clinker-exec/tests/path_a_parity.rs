...
//! fixture from `crates/clinker-exec/tests/fixtures/combine/`.
...
fn workspace_root() -> PathBuf {
    // Crate manifest dir is `<workspace>/crates/clinker-exec`; pop twice.
...
fn test_path_a_combine_strategies_selected_on_enriched_dag() {
    ...
    let plan = compile_fixture_with(
        "crates/clinker-exec/tests/fixtures/combine/combine_empty_build.yaml",
...
fn test_canonical_dag_shape_baselines() {
    let cases = &[
        ...
        (
            ...
            "crates/clinker-exec/tests/fixtures/combine/two_input_equi.yaml",
        ),
        (
            "combine_two_input_mixed",
            "crates/clinker-exec/tests/fixtures/combine/two_input_mixed.yaml",
        ),
    ];
