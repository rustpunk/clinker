...
///
/// The three generated columns lead: the row's id, the id of the failure
/// it belongs to (its trigger row's `_cxl_dlq_id`), and the time the
/// failure was observed. `_cxl_dlq_failure_id` sits next to the id it
