...
- Carry per-target `sources:` config patches (schema / split_to_rows / split_values / options / group_section / set_section / split_fields / records / discriminator) for `apply_source_patches`.
